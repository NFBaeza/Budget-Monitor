...
public:
    ...
    void setupUi(QWidget *MonthView)
    {
        ...
        DeletEntryButtom = new QPushButton(MonthView);
        DeletEntryButtom->setObjectName("DeletEntryButtom");

        horizontalLayout_2->addWidget(DeletEntryButtom);
        ...
        sizePolicy1.setHeightForWidth(Expenses_title->sizePolicy().hasHeightForWidth());
        Expenses_title->setSizePolicy(sizePolicy1);
        ...
        EditButton = new QPushButton(MonthView);
    ...
    void retranslateUi(QWidget *MonthView)
    {
        ...
        DeletEntryButtom->setText(QCoreApplication::translate("MonthView", "Delete Entry", nullptr));
        ...
        EditButton->setText(QCoreApplication::translate("MonthView", "Edit", nullptr));
    } // retranslateUi
